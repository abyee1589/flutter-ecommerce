...
class AbUserProfileTile extends StatelessWidget {
  const AbUserProfileTile({super.key, required this.onPressed});
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Text(
        ...
        style: Theme.of(context).textTheme.headlineSmall!.apply(color: AbColors.white),
      ),
      subtitle: Text(
      ...
      trailing: IconButton(
        onPressed: onPressed,
        icon: const Icon(Iconsax.edit, color: AbColors.white),
      ),
    );
  }
}
