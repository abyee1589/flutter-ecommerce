...
class AbCartCounterIcon extends StatelessWidget {
  const AbCartCounterIcon({super.key, this.iconColor, required this.onPressed});
      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            height: 18,
            width: 18,
            decoration: BoxDecoration(color: AbColors.black, borderRadius: BorderRadius.circular(100)),
            child: Text(
              '2',
