...
class ForgetPassword extends StatelessWidget {
  const ForgetPassword({super.key, this.image, this.title, this.subTitle});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            /// Title and Subtitle
            Text(
              AbTexts.forgetPasswordTitle,
              style: Theme.of(context).textTheme.headlineLarge,
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: AbSizes.spaceBtwItems),
            Text(
              AbTexts.forgetPasswordSubTitle,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text(AbTexts.submit),
              ),
            ),
          ],
        ),
